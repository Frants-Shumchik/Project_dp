<?php
 class Models_Feedback // наследует все методы класса для работы с бд
  {	  
		private $fio;
		private $email;
		private $message;
	...
	$subject = 'Сообщение с формы обратной связи обучающей системы';
	$message = $this->message;

	$headers  = "Content-type: text/html; charset=windows-1251 \r\n"; 
	$headers .= "From: wartortle.com\r\n"; 
	$headers .= "Reply-To: egorbondar13@gmail.com\r\n";
